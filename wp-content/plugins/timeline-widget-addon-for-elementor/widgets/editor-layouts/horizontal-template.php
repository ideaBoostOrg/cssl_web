...
<b>Warning</b>:  Undefined variable $dir in <b>C:\xampp\htdocs\cssl\wp-content\plugins\timeline-widget-addon-for-elementor\widgets\editor-layouts\horizontal-template.php</b> on line <b>20</b><br />
             ...
             if(item.twae_show_year_label == 'yes'){
                ...
                <# }#>
                    ...
                    <# if( item.twae_media == 'image' && image_url!=''){ #>          
                        <div class="twae-media  {{{timeline_image.size}}}"><img src="https://ideaboostorg.github.io/cssl_web/wp-content/plugins/timeline-widget-addon-for-elementor/widgets/editor-layouts/{{{ image_url }}}"></div>
                    <# } #>            
